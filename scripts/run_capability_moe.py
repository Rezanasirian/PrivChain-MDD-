...
def _report(
    ...
    lines = [
        ...
        "",
        f"Inner {inner_folds}-fold CV over the official train split only. Both arms train",
        "under",
        "the identical capability schedule and are scored counterfactually under",
        "every capability, so each estimate uses the whole fold.",
        "",
